import MastersList from "@/components/ui/admin/masterList";
import { StyleTypeList } from "@/components/ui/admin/styleTypeList";
    ...
    <>
      ...
      <Tabs defaultValue="masters" className="w-full h-full">
        <TabsList className="w-full">
          <TabsTrigger value="masters" onClick={() => setTab("masters")}>Masters</TabsTrigger>
          <TabsTrigger value="style_types" onClick={() => setTab("style_types")}>Style Types</TabsTrigger>
        </TabsList>
        <ScrollArea className="pr-2 h-[78%]">
          <TabsContent value="masters">
            <MastersList />
          </TabsContent>
          <TabsContent value="style_types">
            <StyleTypeList />
          </TabsContent>
        </ScrollArea>
      </Tabs>
