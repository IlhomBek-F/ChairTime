...
func SignUp(app *app.Application, e echo.Context) error {
	...
	if !errors.Is(err, gorm.ErrRecordNotFound) || !errors.Is(msErr, gorm.ErrRecordNotFound) || !errors.Is(adErr, gorm.ErrRecordNotFound) {
