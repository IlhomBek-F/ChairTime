...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/master/unavailable-schedule/{unavailable_schedule_id}": {
            "delete": {
                "security": [
                    {
                        "JWT": []
        ...
        "/master/{master_id}/bookings": {
            "get": {
                ...
                "responses": {
                    "201": {
                        "description": "Master bookings",
                        "schema": {
                            "$ref": "#/definitions/domain.MasterBookingRes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/style-type/update": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "style type payload",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "201": {
                        "description": "Master info",
                        "schema": {
                            "$ref": "#/definitions/domain.StyleTypeByIdRes"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.MasterBookingRes": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.MasterBooking"
                    }
                },
                "message": {
                    "type": "string"
